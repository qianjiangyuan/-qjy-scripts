<template>
    <div id="global-uploader">
        ...
        <div
            ...
            <button id="global-uploader-btn" :attrs="attrs" ref="uploadBtn">选择文件</button>
...
import { uploadUrl, mergeUpload } from '@/api/platform.upload'
export default {
  data () {
    return {
      options: {
  ...
  mounted () {
    console.log('begin openUploader')
