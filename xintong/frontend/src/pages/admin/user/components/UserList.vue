  ...
  <div>
    <template  v-if="showDetail==false">
      <el-form ref="form" :inline="true" class="demo-form-inline">
        ...
        <div>
          <div class="inptH32 mg-b10 pd-b5 border-b1">
            ...
            <el-form-item style="">
              <el-button size="small"  @click="deleteUser" :disabled = hideDelete>删除</el-button>
            </el-form-item>
          </div>
          <div>
      ...
      <template v-if="showDetail">
        <user-form :data="item"  @oncancel="cancelAddOrUpdateModel" @onsuccess="commitAddOrUpdateModel"  :readOnly="readOnly" ></user-form>
      </template>
   </div>
</template>

<script>
import { QueryUserList, DeleteUserList } from '@/api/platform.user'
