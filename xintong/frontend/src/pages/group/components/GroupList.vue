  ...
  <div>
    <template  v-if="showDetail==false">
      <el-form ref="form" :inline="true" class="demo-form-inline">
        ...
        <div>
          <div class="inptH32 mg-b10 pd-b5 border-b1">
            ...
            <el-form-item style="">
              <el-button size="small"  @click="deleteGroup" :disabled = hideDelete>删除</el-button>
            </el-form-item>
          </div>
          <div>
      ...
      <template v-if="showDetail">
        <group-form :data="item"    @oncancel="cancelAddOrUpdateModel" @onsuccess="commitAddOrUpdateModel"  :readOnly="readOnly" ></group-form>
      </template>
   </div>
</template>

<script>
import { QueryGroupList, DeleteGroupList } from '@/api/platform.group'
...
export default {
  ...
  methods: {
    queryList () {
      ...
      QueryGroupList(queryparams).then(res => {
        this.loading = false
